...
Deploy the site by running npm run deploy [GitHub Pages deploy](https://create-react-app.dev/docs/deployment#step-3-deploy-the-site-by-running-npm-run-deploy)
